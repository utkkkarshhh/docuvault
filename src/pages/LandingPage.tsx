      ...
      <div className="developers" id="developers">
        <div className="developers-heading">
          ...
          <p className="developers-heading-text">
            DocuVault is a free open-source project for everyone!
          </p>
        </div>
        <div className="developers-cards">
          ...
          <div className="developer-card">
            <div className="developer-card-image">
              <img
                src="https://avatars.githubusercontent.com/u/31732036?v=4"
                alt="Tanish"
              />
            </div>
            <div className="developer-card-text">
              <p className="developer-name">Tanish Baidya</p>
              <div className="developer-links">
                <a href="https://www.linkedin.com/in/tanish-baidya/">
                  <CiLinkedin />
                </a>
                <a href="https://github.com/0xbaitan">
                  <FiGithub />
                </a>
              </div>
              <p className="developer-bio">
